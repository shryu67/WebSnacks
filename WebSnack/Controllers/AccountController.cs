...
namespace WebSnack.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, mname = model.mname, BirthDate = model.BirthDate, mgender = model.mgender, mtel = model.mtel, maddr = model.maddr };
